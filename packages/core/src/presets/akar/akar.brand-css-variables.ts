  ...
  return {
    ...
    getCSS: () => {
      ...
      const lightVars = [
        ...
        '--pohon-text-inverted: var(--akar-neutral-100);',
        '--pohon-bg: var(--akar-neutral-100);',
      ...
      const darkVars = [
        ...
        '--pohon-text-highlighted: var(--akar-neutral-100);',
