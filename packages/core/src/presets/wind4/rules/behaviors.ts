...
export const outline: Array<Rule<Theme>> = [
  // size
...
function handleWidth([, b]: Array<string>): CSSObject | undefined {
...
export const appearance: Array<Rule<Theme>> = [
...
export const willChange: Array<Rule<Theme>> = [
...
export const listStyle: Array<Rule<Theme>> = [
  // base
...
export const accents: Array<Rule<Theme>> = [
...
export const carets: Array<Rule<Theme>> = [
...
export const imageRenderings: Array<Rule<Theme>> = [
...
export const overscrolls: Array<Rule<Theme>> = [
...
export const scrollBehaviors: Array<Rule<Theme>> = [
