/* eslint-disable sonar/no-empty-group,regexp/no-empty-group,regexp/no-empty-capturing-group */
...
export const borders: Array<Rule<Theme>> = [
  // compound
...
function borderColorResolver(direction: string) {
  return ([, body]: Array<string>, ctx: RuleContext<Theme>): [CSSObject, ...Array<CSSValueInput>] | undefined => {
...
function handlerBorderSize([, a = '', b = '1']: Array<string>): CSSEntries | undefined {
...
function handlerBorderColorOrSize([, a = '', b]: Array<string>, ctx: RuleContext<Theme>): CSSEntries | Array<CSSValueInput | string> | undefined {
...
function handlerBorderOpacity([, a = '', opacity]: Array<string>): CSSEntries | undefined {
...
function handlerRounded([, a = '', s]: Array<string>, { theme }: RuleContext<Theme>): CSSEntries | undefined {
  if (a in cornerMap) {
    const _s = s || 'DEFAULT';
    if (_s === 'full') {
...
export function handlerBorderStyle([, a = '', s]: Array<string>): CSSEntries | undefined {
