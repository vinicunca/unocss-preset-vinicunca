...
function toFilter(varName: string, resolver: (str: string, theme: Theme) => string | undefined) {
  return ([, b, s]: Array<string>, { theme }: RuleContext<Theme>): CSSValues | Array<CSSValueInput | string> | undefined => {
...
function dropShadowResolver([, s]: Array<string>, { theme }: RuleContext<Theme>) {
...
export const filters: Array<Rule<Theme>> = [
  // filters
