...
export const positions: Array<Rule<Theme>> = [
...
export const justifies: Array<StaticRule> = [
  // contents
...
export const orders: Array<Rule<Theme>> = [
...
export const alignments: Array<StaticRule> = [
  // contents
...
export const placements: Array<StaticRule> = [
  // contents
...
function handleInsetValues([, d, v]: Array<string>): CSSEntries | undefined {
...
export const insets: Array<Rule<Theme>> = [
  [
    /^(?:position-|pos-)?inset-(.+)$/,
...
export const floats: Array<Rule<Theme>> = [
  // floats
