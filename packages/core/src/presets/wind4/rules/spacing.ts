...
export const paddings: Array<Rule<Theme>> = [
...
export const margins: Array<Rule<Theme>> = [
...
export const spaces: Array<Rule<Theme>> = [
  [/^space-([xy])-(.+)$/, handlerSpace, { autocomplete: ['space-(x|y)', 'space-(x|y)-reverse', 'space-(x|y)-$spacing'] }],
  [/^space-([xy])-reverse$/, function* ([, d]: Array<string>, { symbols }: RuleContext<Theme>) {
    yield {
...
function* handlerSpace([, d, s]: Array<string>, { theme, symbols }: RuleContext<Theme>) {
