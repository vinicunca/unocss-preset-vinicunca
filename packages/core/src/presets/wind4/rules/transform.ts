...
export const transforms: Array<Rule<Theme>> = [
  // origins
  [
    /^(?:transform-)?origin-(.+)$/,
...
type ReturnHandler = CSSValues | Array<CSSValueInput | string> | undefined;

function handleTranslate([, d, b]: Array<string>): ReturnHandler {
...
function handleScale([, d, b]: Array<string>): ReturnHandler {
...
function handleRotate([, d = '', b]: Array<string>): CSSValues | Array<CSSValueInput | string> | undefined {
...
function handleSkew([, d, b]: Array<string>): CSSValues | Array<CSSValueInput | string> | undefined {
