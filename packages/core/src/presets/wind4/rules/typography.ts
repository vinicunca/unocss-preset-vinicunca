...
export const fonts: Array<Rule<Theme>> = [
  // text
...
export const tabSizes: Array<Rule<Theme>> = [
  [/^tab(?:-(.+))?$/, ([, s]) => {
...
export const textIndents: Array<Rule<Theme>> = [
  [/^indent(?:-(.+))?$/, ([, s]) => {
...
export const textStrokes: Array<Rule<Theme>> = [
  // widths
  [/^text-stroke(?:-(.+))?$/, ([, s = 'DEFAULT'], { theme }) => {
    ...
    return {
      ...
      '-webkit-text-stroke-width': theme.textStrokeWidth?.[s]
        ...
        ? passThemeKey.includes(s)
          ? theme.textStrokeWidth?.[s]
          : `var(--text-stroke-width-${s})`
...
export const textShadows: Array<Rule<Theme>> = [
...
export const fontVariantNumeric: Array<Rule<Theme>> = [
...
function handleText([, s = 'base']: Array<string>, { theme }: RuleContext<Theme>): CSSObject | undefined {
...
function handleSize([, s]: Array<string>, { theme }: RuleContext<Theme>): CSSObject | undefined {
...
function handlerColorOrSize(match: RegExpMatchArray, ctx: RuleContext<Theme>): CSSObject | Array<CSSValueInput | string> | undefined {
