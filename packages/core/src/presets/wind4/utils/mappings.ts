export const directionMap: Record<string, Array<string>> = {
  'l': ['-left'],
  'r': ['-right'],
  't': ['-top'],
  'b': ['-bottom'],
...
export const insetMap: Record<string, Array<string>> = {
  ...directionMap,
  x: ['-inset-inline'],
  y: ['-inset-block'],
...
export const cornerMap: Record<string, Array<string>> = {
...
export const xyzMap: Record<string, Array<string>> = {
  'x': ['-x'],
  'y': ['-y'],
  'z': ['-z'],
  '': ['-x', '-y'],
