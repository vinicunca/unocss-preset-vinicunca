...
export function getRemMaxWidth(config: RequiredFluidOptions) {
...
export function getRemMinWidth(config: RequiredFluidOptions) {
...
export function toRem(value: number, config: RequiredFluidOptions) {
  if (config.useRemByDefault) {
    return value;
  } else {
