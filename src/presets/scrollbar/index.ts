...
const defaultOption: Required<UnoPresetScrollbarOption> = {
  scrollbarWidth: '8px',
  scrollbarHeight: '8px',
...
export interface UnoPresetScrollbarOption {
  /**
...
export function presetScrollbar(option?: UnoPresetScrollbarOption): Preset {
  const config = {
    ...defaultOption,
    ...option,
  };
