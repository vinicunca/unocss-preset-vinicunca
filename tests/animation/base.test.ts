  ...
  describe('animate class names', () => {
    it('"animate-in" should generate enter keyframe and css variables', async ({ expect }) => {
      ...
      expect(css).toMatchInlineSnapshot(`
        ...
        .animate-in{animation:vin-in;animation-name:vin-in;animation-duration:var(--defaults-transition-duration);--vin-enter-opacity:initial;--vin-enter-scale:initial;--vin-enter-rotate:initial;--vin-enter-translate-x:initial;--vin-enter-translate-y:initial;}"
      `);
    });
    ...
    it('"animate-out" should generate exit keyframe and css variables', async ({ expect }) => {
      ...
      expect(css).toMatchInlineSnapshot(`
        ...
        .animate-out{animation:vin-out;animation-name:vin-out;animation-duration:var(--defaults-transition-duration);--vin-exit-opacity:initial;--vin-exit-scale:initial;--vin-exit-rotate:initial;--vin-exit-translate-x:initial;--vin-exit-translate-y:initial;}"
      `);
    });
  });
