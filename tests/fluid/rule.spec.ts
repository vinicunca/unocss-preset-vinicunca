...
import { FLUID_UTILITIES } from '../../src/fluid/constant.fluid';
import { REGEX_PATTERNS_NUMERIC_VALUES, REGEX_PATTERNS_RANGE_VALUES } from '../../src/fluid/utils/regex.util';
import { buildMultiplePropertiesRule, buildRule, buildRulesFromUtilities, buildSinglePropertyRule } from '../../src/fluid/utils/rule.util';
...
describe('buildRules', () => {
  ...
  it('build rules from utilities', () => {
    const rules = buildRulesFromUtilities(defaultFluidOptions);
